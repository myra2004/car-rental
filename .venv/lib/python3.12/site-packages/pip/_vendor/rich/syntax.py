...
=======
        best lexer to use. For example, if the file is ``index1.html`` and the file contains Django
        templating syntax, then "html+django" will be returned. If the file is ``index1.html``, and no
>>>>>>> 464db674f306f71bb1f1c0192888868881727d73
